...
import com.codenvy.api.dao.mongo.DocumentedCodec;
...
public class RecipeImplCodec implements Codec<RecipeImpl> {
    ...
    private final DocumentedCodec<AclEntryImpl> aclEntryCodec;

    public RecipeImplCodec(CodecRegistry registry) {
        this.codec = registry.get(Document.class);
        this.aclEntryCodec = (DocumentedCodec<AclEntryImpl>)registry.get(AclEntryImpl.class);
    }
