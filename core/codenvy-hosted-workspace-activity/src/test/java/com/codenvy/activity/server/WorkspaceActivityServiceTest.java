...
public class WorkspaceActivityServiceTest {
    ...
    private static final User   TEST_USER        = new UserImpl("name", USER_ID, "token", null, false);
    @Mock
    ...
    @Test
    public void shouldUpdateWorkspaceActivityOnRunningWorkspace() throws NotFoundException, ServerException {
        // given
    ...
    @Test
    public void shouldThrowExceptionWhenUpdatingWorkspaceActivity() throws NotFoundException, ServerException {
        // given
    ...
    @Test
    public void shouldNotUpdateWorkspaceActivityOnNotRunningWorkspace() throws NotFoundException, ServerException {
        // given
        final WorkspaceImpl workspace = createWorkspace(USER_ID, WorkspaceStatus.STARTING);
        when(workspaceManager.getWorkspace(WORKSPACE_ID)).thenReturn(workspace);
        // when
        Response response = given().when().put(SERVICE_PATH + '/' + WORKSPACE_ID);
